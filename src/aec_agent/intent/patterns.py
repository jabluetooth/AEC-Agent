...
MEP_PATTERNS: dict[MEPDomain, dict[str, tuple[float, Optional[str]]]] = {
    ...
    # =========================================================================
    # LOW VOLTAGE - Security, Fire Alarm, BMS, AV, Data/Telecom
    # =========================================================================
    MEPDomain.LOW_VOLTAGE: {
        # Security Systems
        "access control": (3.0, "security"),
        "card reader": (3.0, "security"),
        "cctv": (3.0, "security"),
        "security camera": (3.0, "security"),
        "camera": (2.5, "security"),
        "surveillance": (3.0, "security"),
        "security panel": (3.0, "security"),
        "door contact": (3.0, "security"),
        "motion sensor": (2.5, "security"),
        "motion detector": (3.0, "security"),
        "intrusion": (3.0, "security"),
        "intrusion detection": (3.0, "security"),
        "pir": (3.0, "security"),
        "badge reader": (3.0, "security"),
        "keypad": (2.5, "security"),
        "intercom": (3.0, "security"),
        "video intercom": (3.0, "security"),
        "dvr": (3.0, "security"),
        "nvr": (3.0, "security"),

        # Fire Alarm (detection systems, different from fire protection/suppression)
        "fire alarm panel": (3.0, "fire_alarm"),
        "facp": (3.0, "fire_alarm"),
        "fire alarm control panel": (3.0, "fire_alarm"),
        "smoke detector": (3.0, "fire_alarm"),
        "heat detector": (3.0, "fire_alarm"),
        "duct detector": (3.0, "fire_alarm"),
        "beam detector": (3.0, "fire_alarm"),
        "pull station": (3.0, "fire_alarm"),
        "manual pull": (3.0, "fire_alarm"),
        "horn strobe": (3.0, "fire_alarm"),
        "notification appliance": (3.0, "fire_alarm"),
        "nac": (3.0, "fire_alarm"),
        "slc": (3.0, "fire_alarm"),
        "addressable": (2.5, "fire_alarm"),
        "conventional": (2.0, "fire_alarm"),

        # BMS / BAS (Building Management/Automation)
        "bms": (3.0, "bms"),
        "bas": (3.0, "bms"),
        "building automation": (3.0, "bms"),
        "building management": (3.0, "bms"),
        "ddc": (3.0, "bms"),
        "direct digital control": (3.0, "bms"),
        "controller": (2.0, "bms"),
        "ddc controller": (3.0, "bms"),
        "bacnet": (3.0, "bms"),
        "modbus": (3.0, "bms"),
        "lonworks": (3.0, "bms"),
        "jace": (3.0, "bms"),
        ...
        "av": (2.5, "av"),
        "speaker": (2.5, "av"),
        "ceiling speaker": (3.0, "av"),
        "projector": (3.0, "av"),
        "display": (2.0, "av"),
        "video display": (3.0, "av"),
        "microphone": (2.5, "av"),
        "amplifier": (3.0, "av"),
        "mixer": (2.5, "av"),
        "paging": (3.0, "av"),
        "paging system": (3.0, "av"),
        "sound masking": (3.0, "av"),
        "digital signage": (3.0, "av"),

        # Data / Telecom
        "data outlet": (3.0, "data"),
        "network outlet": (3.0, "data"),
        "ethernet": (3.0, "data"),
        "network jack": (3.0, "data"),
        "patch panel": (3.0, "data"),
        "network switch": (3.0, "data"),
        "network rack": (3.0, "data"),
        "idf": (3.0, "data"),
        "mdf": (3.0, "data"),
        "telecom room": (3.0, "data"),
        "tr": (2.5, "data"),
        "telecom": (3.0, "data"),
        "telecommunications": (3.0, "data"),
        "cat6": (3.0, "data"),
        "cat6a": (3.0, "data"),
        "fiber": (2.5, "data"),
        "fiber optic": (3.0, "data"),
        "wifi": (3.0, "data"),
        "wireless": (2.5, "data"),
        "access point": (3.0, "data"),
        "wap": (3.0, "data"),
        "wireless access point": (3.0, "data"),
        "network cable": (3.0, "data"),
        "structured cabling": (3.0, "data"),
        "cable pathway": (2.5, "data"),
        "j-hook": (3.0, "data"),
        "cable tray": (2.5, "data"),

        # General Low Voltage terms
        "low voltage": (3.0, None),
        "lv": (2.5, None),
        "technology": (1.5, None),
        "it infrastructure": (3.0, None),
    },
}
